// {namespace name="backend/emotion/myfavspecial_box_element"}
//{block name="emotion_components/backend/myfavspecialbox_myfavspecialbox"}
Ext.define('Shopware.apps.Emotion.view.components.myfavspecialbox', {
     ...
     */
    alias: 'widget.emotion-components-myfavspecialbox',
