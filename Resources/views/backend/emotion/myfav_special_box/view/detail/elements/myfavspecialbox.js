...
//{$smarty.block.parent}
Ext.define('Shopware.apps.Emotion.view.detail.elements.Myfavspecialbox', {
     ...
     */
    alias: 'widget.detail-element-emotion-components-myfavspecialbox',

    /**
     * You can define an additional CSS class which will be used for the grid element.
     */
    componentCls: 'emotion--myfavspecialbox',
     ...
     */
        ...
        var me = this,
            preview = '',
            image = me.getConfigValue('myfavspecialbox_thumbnail'),
            style;
